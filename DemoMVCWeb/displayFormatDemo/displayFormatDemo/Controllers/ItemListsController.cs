...
namespace displayFormatDemo.Controllers
{
    public class ItemListsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ListItemID,Title,ListItemEntry,EntryCreateDate")] ItemList itemList)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ListItemID,Title,ListItemEntry,EntryCreateDate")] ItemList itemList)
        {
            if (ModelState.IsValid)
            {
