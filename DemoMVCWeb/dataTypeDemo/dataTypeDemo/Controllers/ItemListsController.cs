...
using dataTypeDemo.Models;

namespace dataTypeDemo.Controllers
{
    public class ItemListsController : Controller
    {
        private ItemListDB db = new ItemListDB();
        ...
        public ActionResult Create([Bind(Include = "ListItemID,Title,ListItemEntry,fundsRequired")] ItemList itemList)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ListItemID,Title,ListItemEntry,fundsRequired")] ItemList itemList)
        {
            if (ModelState.IsValid)
            {
